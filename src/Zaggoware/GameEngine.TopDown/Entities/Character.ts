/// <reference path="Cosmetics/CharacterCosmetics.ts" />

namespace Zaggoware.GameEngine.TopDown.Entities {
    import CharacterCosmetics = Cosmetics.CharacterCosmetics;
    import CosmeticsItem = Cosmetics.CosmeticsItem;
    import Texture = Textures.Texture;
    import SpritesheetStateManager = Textures.SpritesheetStateManager;
    import SpriteState = Textures.SpriteState;
    import IMap = TopDown.Environment.IMap;
    import ITile = TopDown.Environment.ITile;
    ...
    export class Character implements IInitializable, IUpdatable, IDrawableWithContext {
        ...
        private _shadow: Texture;
        private _spritesheetStateManager: SpritesheetStateManager;
        ...
        public constructor(name: string, viewport: Viewport, camera: Camera) {
            ...
            this._spritesheetStateManager = new SpritesheetStateManager();
        ...
        public get shadow(): Texture {
            return this._shadow;
        }

        public set shadow(texture: Texture) {
        ...
        public initialize(): void {
            ...
            if (!this._shadow) {
                this._shadow = new Texture("Resources/Textures/Entities/CharacterShadow.png");
            }

            // TODO: Remove hardcoded mappings: load from json file.
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Standing + FaceDirections.Down, [new Rectangle(32, 0, 32, 32)]));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Standing + FaceDirections.Left, [new Rectangle(32, 32, 32, 32)]));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Standing + FaceDirections.Up, [new Rectangle(32, 96, 32, 32)]));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Standing + FaceDirections.Right, [new Rectangle(32, 64, 32, 32)]));

            const walkInterval = 1000 * this.walkSpeed;
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Walking + FaceDirections.Down, [new Rectangle(0, 0, 32, 32), new Rectangle(32, 0, 32, 32), new Rectangle(64, 0, 32, 32), new Rectangle(32, 0, 32, 32)], walkInterval));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Walking + FaceDirections.Left, [new Rectangle(0, 32, 32, 32), new Rectangle(32, 32, 32, 32), new Rectangle(64, 32, 32, 32), new Rectangle(32, 32, 32, 32)], walkInterval));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Walking + FaceDirections.Up, [new Rectangle(0, 96, 32, 32), new Rectangle(32, 96, 32, 32), new Rectangle(64, 96, 32, 32), new Rectangle(32, 96, 32, 32)], walkInterval));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Walking + FaceDirections.Right, [new Rectangle(0, 64, 32, 32), new Rectangle(32, 64, 32, 32), new Rectangle(64, 64, 32, 32), new Rectangle(32, 64, 32, 32)], walkInterval));

            const runInterval = walkInterval * (this.walkSpeed / this.runSpeed);
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Running + FaceDirections.Down, [new Rectangle(0, 0, 32, 32), new Rectangle(32, 0, 32, 32), new Rectangle(64, 0, 32, 32), new Rectangle(32, 0, 32, 32)], runInterval));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Running + FaceDirections.Left, [new Rectangle(0, 32, 32, 32), new Rectangle(32, 32, 32, 32), new Rectangle(64, 32, 32, 32), new Rectangle(32, 32, 32, 32)], runInterval));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Running + FaceDirections.Up, [new Rectangle(0, 96, 32, 32), new Rectangle(32, 96, 32, 32), new Rectangle(64, 96, 32, 32), new Rectangle(32, 96, 32, 32)], runInterval));
            this._spritesheetStateManager.add(new SpriteState(CharacterStates.Running + FaceDirections.Right, [new Rectangle(0, 64, 32, 32), new Rectangle(32, 64, 32, 32), new Rectangle(64, 64, 32, 32), new Rectangle(32, 64, 32, 32)], runInterval));

            if (!Character.baseTexture) {
                Character.baseTexture = new Texture("Resources/Textures/Entities/Base.png");
        ...
        */
        ...
        private drawCosmeticsItem(context: CanvasRenderingContext2D, item: CosmeticsItem, texture: Texture, sprite: SpriteState, destination: Rectangle): void {
            if (!item) {
                return;
            }
        ...
        private getTileAtXY(x: number, y: number): ITile {
