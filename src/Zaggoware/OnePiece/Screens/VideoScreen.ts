namespace Zaggoware.OnePiece.Screens {
    ...
    import EventManager = GameEngine.EventManager;
    import IEventHandler = GameEngine.IEventHandler;
    import IPromise = GameEngine.IPromise;
    import SimplePromise = GameEngine.SimplePromise;
