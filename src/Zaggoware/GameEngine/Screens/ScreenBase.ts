/// <reference path="../UI/ControlManager.ts" />
/// <reference path="../UI/DialogManager.ts" />
/// <reference path="IScreenComponent.ts" />
/// <reference path="ScreenStates.ts" />
/// <reference path="BackgroundImageFillStyles.ts" />

namespace Zaggoware.GameEngine.Screens {
    import ControlManager = UI.ControlManager;
    import DialogManager = UI.DialogManager;
    ...
    export abstract class ScreenBase implements IGameComponent, IInitializable, IUpdatable, IDrawable {
        ...
        public constructor(game: GameBase, name: string) {
            if (!name || !name.length) {
        ...
        public initialize(): void {
            ...
            this._controlManager = new ControlManager(this.game, this.uiLayer);
            this._controlManager.initialize();

            this._dialogManager = new DialogManager(this.game, this.uiLayer);
